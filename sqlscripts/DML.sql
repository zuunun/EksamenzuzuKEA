...
VALUES ('Website Development', 50000.00, 'Development of a new company website',
        1), -- Projekt tilknyttet første projektleder
       ('App Development', 75000.00, 'Development of a mobile app', 1);
-- Projekt tilknyttet første projektleder

-- Indsæt data i Subproject tabellen
INSERT INTO subproject (subproject_name, subproject_description, project_id)
VALUES ('Frontend Development', 'Develop the user interface for the website', 1), -- Subprojekt til første projekt
...
-- Subprojekt til andet projekt

-- Indsæt data i Task tabellen
INSERT INTO task (task_name, startdate, enddate, status, subproject_id)
VALUES ('Create Homepage', '2024-11-01', '2024-11-10', 'INPROGRESS', 1), -- Opgave under frontend-udvikling
